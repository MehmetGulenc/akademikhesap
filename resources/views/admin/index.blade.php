                                        ...
                                        <div class="col-6">
                                            <div class="d-flex align-items-center">
                                                <svg class="bi text-primary" width="32" height="32" fill="blue"
                                                     style="width:10px">
                                                    <use
                                                        xlink:href="{{asset('assets/admin-temp/vendors/bootstrap-icons/bootstrap-icons.svg#circle-fill')}}" />
                                                </svg>
                                        ...
                                        <table class="table table-hover table-lg">
                                                ...
                                                <td class="col-3">
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-md">
                                                            <img src="{{asset('assets/admin-temp/images/faces/5.jpg')}}">
                                                        </div>
                                            ...
                                            <tr>
                                                <td class="col-3">
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-md">
                                                            <img src="{{asset('assets/admin-temp/images/faces/2.jpg')}}">
                                                        </div>
                        ...
                        <div class="card-content pb-4">
                            <div class="recent-message d-flex px-4 py-3">
                                <div class="avatar avatar-lg">
                                    <img src="{{asset('assets/admin-temp/images/faces/4.jpg')}}">
                                </div>
                                <div class="name ms-4">
